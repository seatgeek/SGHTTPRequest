...
- (void)runTestsForCache:(NSString *)cacheName {
    XCTAssertNil([SGCache cacheFor:cacheName] secondaryKeyValueNamed:nil forPrimaryKey:nil], @"Nil primary and secondary keys should return nil secondary key value");
    XCTAssertNil([SGCache cacheFor:cacheName] secondaryKeyValueNamed:nil forPrimaryKey:@"test_pk"], @"Nil secondary key should return nil secondary key value");
    XCTAssertNil([SGCache cacheFor:cacheName] secondaryKeyValueNamed:@"test_sk" forPrimaryKey:nil], @"Nil primary key should return nil secondary key value");
